...
<head>
	...
	<meta property="og:title" content="Gacha Vault" key="ecritorio-title-og" />
	<meta content="en_EN" property="og:locale" />
	<meta content="Gacha Vault" property="og:site_name" />
...
<div class="relative pt-10 pb-10 bg-white">
	<div class="relative container m-auto px-6 md:px-12 lg:px-6">
		<h1 class="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-4xl text-center sm:text-5xl lg:w-auto lg:text-left">Gacha Vault</h1>
		<div class="lg:flex">
